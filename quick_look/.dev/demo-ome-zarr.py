...
write_image(image=data, group=root, axes="cyx", storage_options=dict(chunks=(1, size_xy, size_xy)))
...
# viewer.add_image(np.eye(3), scale=(2, 3), translate=np.multiply((.5, .5), (2, 3))-.5, colormap='viridis')